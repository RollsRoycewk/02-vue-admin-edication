			...
			>
				...
				<el-form-item label="所属银行" prop="bank">
					<el-select v-model="temp.bank" placeholder="请选择">
						<el-option v-for="item in banks" :key="item.value" :label="item.text" :value="item.text"></el-option>
					</el-select>
				</el-form-item>
...
import { fetchPayments, createPayment, updatePayment, deletePayment } from '@/api/pay';
