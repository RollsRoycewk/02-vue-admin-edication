	...
	<div class="book" v-loading="listLoading">
		<div class="book-header">
			...
			<div style="display: flex; align-items: center">
				...
				<el-checkbox v-model="temp.isfree" :true-label="1" :false-label="0" style="margin-right: 10px">
					免费试看
				</el-checkbox>
		...
		<div class="book-body">
			<div style="height: 80vh; overflow-y: auto">
				<drag-menu @click="handleClick" :list="list" @del="handleDelete"></drag-menu>
...
import { createBookDetail, updateBookDetail, fetchBookDetail } from '@/api/book';
...
export default {
		...
		return {
			...
			editor: {
				toolbar: [
					...
					'blockquote undo removeformat code codesample forecolor backcolor fullscreen',
					'hr bullist numlist link image table'
				]
			}
		};
	},
	...
	methods: {
		handleUpdate() {
			...
			updateBookDetail(this.temp).then((res) => {
				this.getList();
				this.$message({
					message: '修改成功',
					type: 'success'
