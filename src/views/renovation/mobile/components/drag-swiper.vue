<template>
	<div>
		<draggable :list="list" group="course" class="dragArea">
			<div
			...
			>
				...
				<div @click="handleUploadImage(element)" v-if="!element.src" style="height: 150px">点击上传轮播图</div>
				...
				<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 10px">
					...
					<div v-if="element.type" style="margin-top: 10px">
						<el-button type="primary" size="mini" v-if="element.type == 'course'" @click="handleChooseCourse(element)">
							{{ element.course_title || '关联课程' }}
						</el-button>
