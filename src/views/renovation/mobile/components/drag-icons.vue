				...
				<div style="display: flex; align-items: center">
					...
					>
						...
						<div v-if="element.type" style="margin-top: 10px">
							<el-button type="primary" size="mini" v-if="element.type == 'page'" @click="handleChoosePage(element)">
								{{ element.page_title || '关联页面' }}
							</el-button>
							<el-button
								type="primary"
								size="mini"
								v-else-if="element.type == 'course'"
								@click="handleChooseCourse(element)"
							>
