	...
	<div class="app-container">
		...
		<el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
			...
			<el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
				<template slot-scope="{ row, $index }">
					<el-button type="primary" size="mini" @click="openSetRoles(row)">配置权限</el-button>
		...
		<el-dialog title="添加员工" :visible.sync="dialogFormVisible">
			...
			>
				<el-form-item label="关键词" prop="title">
					<el-input v-model="temp.title" placeholder="用户名/手机/邮箱" />
				</el-form-item>
			</el-form>
		...
		<el-dialog title="配置权限" :visible.sync="rolesVisible">
			...
			<div slot="footer" class="dialog-footer">
				...
				<el-button type="primary" @click="handleSetRoles">提交</el-button>
			</div>
		</el-dialog>
	</div>
</template>
...
<script>
import { fetchStaff, createStaff, setRoles, deleteStaff } from '@/api/staff';
